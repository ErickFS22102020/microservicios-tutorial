...
public class UsuarioController {
	...
	public ResponseEntity<Carro> guardarCarroUsuarioId(@PathVariable("usuarioId") int usuarioId, @RequestBody Carro carro){
		Carro nuevoCarro = usuarioService.saveCarro(usuarioId, carro);
		return ResponseEntity.ok(nuevoCarro);
	}
	
	@PostMapping("/moto/{usuarioId}")
	public ResponseEntity<Moto> guardarMotoUsuarioId(@PathVariable("usuarioId") int usuarioId, @RequestBody Moto moto){
